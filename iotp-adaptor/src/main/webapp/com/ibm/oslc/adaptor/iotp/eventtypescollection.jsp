...
<%
  List<EventType> resources = (List<EventType>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability EventTypeQueryCapability</title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;EventTypeQueryCapability&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
          Number of elements:&nbsp;
          <%= resources.size()%>
      </div>
    </div>
        <% for (EventType aResource : resources) { %>
        <% } %>
