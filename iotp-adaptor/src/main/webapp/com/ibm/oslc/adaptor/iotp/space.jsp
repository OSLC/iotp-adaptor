...
<%@page import="com.ibm.oslc.adaptor.iotp.resources.Space"%>

<%@ page contentType="text/html" language="java" pageEncoding="UTF-8" %>

<%
  Space aSpace = (Space) request.getAttribute("aSpace");
%>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <title><%= aSpace.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Space resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aSpace.getAbout() %>"><%= aSpace.getAbout() %></a>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">scopes</dt>
            <dd class="col-sm-9"><%= aSpace.scopesToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">provisions</dt>
            <dd class="col-sm-9"><%= aSpace.provisionsToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">description</dt>
            <dd class="col-sm-9"><%= aSpace.descriptionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">identifier</dt>
            <dd class="col-sm-9"><%= aSpace.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">shortTitle</dt>
            <dd class="col-sm-9"><%= aSpace.shortTitleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">title</dt>
            <dd class="col-sm-9"><%= aSpace.titleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">contributor</dt>
            <dd class="col-sm-9"><%= aSpace.contributorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">creator</dt>
            <dd class="col-sm-9"><%= aSpace.creatorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">subject</dt>
            <dd class="col-sm-9"><%= aSpace.subjectToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">created</dt>
            <dd class="col-sm-9"><%= aSpace.createdToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">modified</dt>
            <dd class="col-sm-9"><%= aSpace.modifiedToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">type</dt>
            <dd class="col-sm-9"><%= aSpace.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">discussedBy</dt>
            <dd class="col-sm-9"><%= aSpace.discussedByToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">instanceShape</dt>
            <dd class="col-sm-9"><%= aSpace.instanceShapeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">serviceProvider</dt>
            <dd class="col-sm-9"><%= aSpace.serviceProviderToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">relation</dt>
            <dd class="col-sm-9"><%= aSpace.relationToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
