...
<%@page import="com.ibm.oslc.adaptor.iotp.resources.NodeREDApp"%>

<%@ page contentType="text/html" language="java" pageEncoding="UTF-8" %>

<%
  NodeREDApp aNodeREDApp = (NodeREDApp) request.getAttribute("aNodeREDApp");
%>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <title><%= aNodeREDApp.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>NodeREDApp resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aNodeREDApp.getAbout() %>"><%= aNodeREDApp.getAbout() %></a>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">flows</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.flowsToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">binds</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.bindsToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">description</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.descriptionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">identifier</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">shortTitle</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.shortTitleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">title</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.titleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">contributor</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.contributorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">creator</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.creatorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">subject</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.subjectToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">created</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.createdToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">modified</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.modifiedToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">type</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">discussedBy</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.discussedByToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">instanceShape</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.instanceShapeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">serviceProvider</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.serviceProviderToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">relation</dt>
            <dd class="col-sm-9"><%= aNodeREDApp.relationToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
