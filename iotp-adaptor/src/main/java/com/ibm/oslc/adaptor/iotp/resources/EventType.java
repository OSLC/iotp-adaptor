    ...
    implements IEventType
{
    ...
    public EventType(final URI about)
           throws URISyntaxException
    {
        super(about);
    ...
    */
    @Deprecated
    public EventType(final String iotId, final String eventTypeId)
           throws URISyntaxException
    {
        this (constructURI(iotId, eventTypeId));
    ...
    */
    @Deprecated
    public static URI constructURI(final String iotId, final String eventTypeId)
    {
    ...
    */
    @Deprecated
    public static Link constructLink(final String iotId, final String eventTypeId , final String label)
    {
        return new Link(constructURI(iotId, eventTypeId), label);
    }
    ...
    */
    @Deprecated
    public static Link constructLink(final String iotId, final String eventTypeId)
    {
        return new Link(constructURI(iotId, eventTypeId));
    }
    
    public static ResourceShape createResourceShape() throws OslcCoreApplicationException, URISyntaxException {
        return ResourceShapeFactory.createResourceShape(OSLC4JUtils.getServletURI(),
        OslcConstants.PATH_RESOURCE_SHAPES,
        Oslc_iotDomainConstants.EVENTTYPE_PATH,
        EventType.class);
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local EventType Resource} - update EventType.toString() to present resource as desired.";
