...
@Path("bmx")
public class BmxServiceProviderService
{
    ...
    @Path("{bmxId}")
    @Produces({OslcMediaType.APPLICATION_RDF_XML, OslcMediaType.APPLICATION_XML, OslcMediaType.APPLICATION_JSON, OslcMediaType.TEXT_TURTLE})
    public ServiceProvider getServiceProvider(@PathParam("bmxId") final String bmxId)
    {
        httpServletResponse.addHeader("Oslc-Core-Version","2.0");
        return ServiceProviderCatalogSingleton.getBmxServiceProvider(httpServletRequest, bmxId);
    }
    ...
    public void getHtmlServiceProvider(@PathParam("bmxId") final String bmxId)
    {
        ServiceProvider serviceProvider = ServiceProviderCatalogSingleton.getBmxServiceProvider(httpServletRequest, bmxId);
        ...
        RequestDispatcher rd = httpServletRequest.getRequestDispatcher("/com/ibm/oslc/adaptor/iotp/bmxserviceprovider.jsp");
        try {
