    ...
    implements ISchema
{
    ...
    */
    @Deprecated
    public Schema(final String iotId, final String schemaId)
           throws URISyntaxException
    {
        this (constructURI(iotId, schemaId));
    ...
    */
    @Deprecated
    public static URI constructURI(final String iotId, final String schemaId)
    {
    ...
    */
    @Deprecated
    public static Link constructLink(final String iotId, final String schemaId , final String label)
    {
        return new Link(constructURI(iotId, schemaId), label);
    }
    ...
    */
    @Deprecated
    public static Link constructLink(final String iotId, final String schemaId)
    {
        return new Link(constructURI(iotId, schemaId));
    }
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local Schema Resource} - update Schema.toString() to present resource as desired.";
