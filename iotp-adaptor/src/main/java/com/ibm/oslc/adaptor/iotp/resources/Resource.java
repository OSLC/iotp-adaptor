    ...
    implements IResource
{
    ...
    public Resource(final String id, JsonObject jsonObject) throws URISyntaxException {
		super();
		...
		// Note: the id is not always provided in the JSON
		this.setIdentifier(id);
		element = jsonObject.get("id");
		if (element != null) this.setShortTitle(element.getAsString());
		try {
			element = jsonObject.get("createdDateTime");
			if (element != null) this.setCreated(createDateFormat.parse(element.getAsString()));
			element = jsonObject.get("updatedDateTime");
    ...
    public JsonElement toJson() {
		...
		if (getCreated() != null) json.addProperty("createdDateTime", createDateFormat.format(getCreated()));
		if (getModified() != null) json.addProperty("updatedDateTime", updateDateFormat.format(getModified()));		
		return json;
    }
    // End of user code
    public Resource()
    ...
    static public String descriptionToHtmlForCreation (final HttpServletRequest httpServletRequest)
    {
        ...
        s= s + "<textarea name=\"description\" cols=\"60\" rows=\"5\" id=\"description\" ></textarea>";
        if (s != null) return s;
        // End of user code
    ...
    static public String relationToHtmlForCreation1 (final HttpServletRequest httpServletRequest, final String iotId)
    {
        String s = "";
    
        // Start of user code "Init:relationToHtmlForCreation1(...final String iotId)"
        // End of user code
    
        s = s + "<label for=\"relation\">relation: </LABEL>";
    
        // Start of user code "Mid:relationToHtmlForCreation1(...final String iotId)"
        // End of user code
    
        // Start of user code "Finalize:relationToHtmlForCreation1(...final String iotId)"
        // End of user code
