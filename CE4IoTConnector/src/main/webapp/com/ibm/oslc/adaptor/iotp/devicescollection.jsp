...
<%
  List<Device> resources = (List<Device>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability DeviceQueryCapability</title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;DeviceQueryCapability&quot; results</h1>
