...
<%
  DeviceType aDeviceType = (DeviceType) request.getAttribute("aDeviceType");
%>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <title><%= aDeviceType.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>DeviceType resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aDeviceType.getAbout() %>"><%= aDeviceType.getAbout() %></a>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">deviceTypeMappings</dt>
            <dd class="col-sm-9"><%= aDeviceType.deviceTypeMappingsToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">physicalInterface</dt>
            <dd class="col-sm-9"><%= aDeviceType.physicalInterfaceToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">logicalInterfaces</dt>
            <dd class="col-sm-9"><%= aDeviceType.logicalInterfacesToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">deviceInfo</dt>
            <dd class="col-sm-9"><%= aDeviceType.deviceInfoToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">metaData</dt>
            <dd class="col-sm-9"><%= aDeviceType.metaDataToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">classId</dt>
            <dd class="col-sm-9"><%= aDeviceType.classIdToHtml()%></dd>
          </dl>
          <dl class="row">
          ...
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDeviceType.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">shortTitle</dt>
            <dd class="col-sm-9"><%= aDeviceType.shortTitleToHtml()%></dd>
          </dl>
          <dl class="row">
          ...
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDeviceType.contributorToHtml()%></dd>
          </dl>
          <dl class="row">
          ...
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDeviceType.subjectToHtml()%></dd>
          </dl>
          <dl class="row">
          ...
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDeviceType.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">discussedBy</dt>
            <dd class="col-sm-9"><%= aDeviceType.discussedByToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">instanceShape</dt>
            <dd class="col-sm-9"><%= aDeviceType.instanceShapeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">serviceProvider</dt>
            <dd class="col-sm-9"><%= aDeviceType.serviceProviderToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">relation</dt>
            <dd class="col-sm-9"><%= aDeviceType.relationToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
