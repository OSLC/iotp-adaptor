...
<html>
  <head>
    ...
    <title>RuleCreationDialog</title>
  ...
  <body style="padding: 10px;">
    ...
    <form id="Create" method="POST" class="enter_bug_form">
        <table style="clear: both;">
          <tr>
            <td><%= Rule.conditionToHtmlForCreation1(request, iotId)%></td>
          </tr>
          <tr>
            <td><%= Rule.actionToHtmlForCreation1(request, iotId)%></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><%= Rule.shortTitleToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.titleToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.contributorToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.creatorToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.subjectToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.createdToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.modifiedToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.typeToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.discussedByToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.instanceShapeToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.serviceProviderToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td><%= Rule.relationToHtmlForCreation(request)%></td>
          </tr>
          <tr>
            <td></td>
            <td>
