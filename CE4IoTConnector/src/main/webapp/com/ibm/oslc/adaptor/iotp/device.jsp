...
<head>
  ...
  <title><%= aDevice.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>Device resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aDevice.getAbout() %>"><%= aDevice.getAbout() %></a>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          ...
          <dl class="row">
            <dt  class="col-sm-2 text-right">typeId</dt>
          ...
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDevice.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">shortTitle</dt>
            <dd class="col-sm-9"><%= aDevice.shortTitleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">title</dt>
            <dd class="col-sm-9"><%= aDevice.titleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">contributor</dt>
            <dd class="col-sm-9"><%= aDevice.contributorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">creator</dt>
            <dd class="col-sm-9"><%= aDevice.creatorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">subject</dt>
            <dd class="col-sm-9"><%= aDevice.subjectToHtml()%></dd>
          </dl>
          <dl class="row">
          ...
          <dl class="row">
            ...
            <dd class="col-sm-9"><%= aDevice.modifiedToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">type</dt>
            <dd class="col-sm-9"><%= aDevice.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">discussedBy</dt>
            <dd class="col-sm-9"><%= aDevice.discussedByToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">instanceShape</dt>
            <dd class="col-sm-9"><%= aDevice.instanceShapeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">serviceProvider</dt>
            <dd class="col-sm-9"><%= aDevice.serviceProviderToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">relation</dt>
            <dd class="col-sm-9"><%= aDevice.relationToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
