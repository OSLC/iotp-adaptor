...
<%
  List<Schema> resources = (List<Schema>) request.getAttribute("resources");
...
<head>
  ...
  <title>Query capability SchemaQueryCapability</title>
...
<nav class="navbar sticky-top navbar-light bg-light">
  ...
  <div class="container">
    <div class="page-header">
      <h1>Query Capability &quot;SchemaQueryCapability&quot; results</h1>
      <div class="alert alert-secondary" role="alert">
          Number of elements:&nbsp;
          <%= resources.size()%>
      </div>
    </div>
        <% for (Schema aResource : resources) { %>
        <% } %>
