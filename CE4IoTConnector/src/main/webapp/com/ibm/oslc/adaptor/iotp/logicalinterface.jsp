...
<%
  LogicalInterface aLogicalInterface = (LogicalInterface) request.getAttribute("aLogicalInterface");
%>
<html lang="en">
<head>
  <meta charset="utf-8">
  ...
  <title><%= aLogicalInterface.toString(true) %></title>
...
<div class="container">
    <div class="page-header">
        <h1>LogicalInterface resource</h1>
        <p class="lead">URI:&nbsp;
      <a href="<%= aLogicalInterface.getAbout() %>"><%= aLogicalInterface.getAbout() %></a>
        </p>
    </div>
        <h2>Properties</h2>
        ...
        <div>
          <dl class="row">
            <dt  class="col-sm-2 text-right">schema</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.schemaToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">description</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.descriptionToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">identifier</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.identifierToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">shortTitle</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.shortTitleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">title</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.titleToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">contributor</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.contributorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">creator</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.creatorToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">subject</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.subjectToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">created</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.createdToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">modified</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.modifiedToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">type</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.typeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">discussedBy</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.discussedByToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">instanceShape</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.instanceShapeToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">serviceProvider</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.serviceProviderToHtml()%></dd>
          </dl>
          <dl class="row">
            <dt  class="col-sm-2 text-right">relation</dt>
            <dd class="col-sm-9"><%= aLogicalInterface.relationToHtml()%></dd>
          </dl>
        </div>
      </div>
    </div>
