...
import com.ibm.oslc.adaptor.iotp.resources.RdfsDomainConstants;
import com.ibm.oslc.adaptor.iotp.resources.IRdfsClass;

// Start of user code imports
// End of user code

@OslcNamespace(RdfsDomainConstants.RDFS_NAMSPACE)
@OslcName(RdfsDomainConstants.RDFSCLASS)
@OslcResourceShape(title = "Class Resource Shape", describes = RdfsDomainConstants.TYPE_RDFSCLASS)
public interface IRdfsClass
{
    ...
    @OslcRange({RdfsDomainConstants.TYPE_RDFSCLASS})
    @OslcReadOnly(false)
